...
if vcs==2 && nd>1
    [gamma x w sigu like]=champ_mat(y,f,sigu,nem,nd,nupd,gamma0,retx);
else
    [gamma x w sigu like]=champ_vec(y,f,sigu,nem,nd,vcs,nupd,gamma0,retx);
end

return


function [gamma,x,w,sigu,like]=champ_vec(y,f,sigu,nem,nd,vcs,nupd,gamma0,retx)
eps1=1e-8;
eps1z=1e-8;
[nk ,nvd]=size(f);
nv=nvd/nd;
...
function [gamma,x,w,sigu,like]=champ_mat(y,f,sigu,nem,nd,nupd,gamma0,retx)
